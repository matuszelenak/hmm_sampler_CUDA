...
nvcc -arch sm_35 -o  hmm_sampler HMM.o State.o LogNum.o main.o gpu_algorithms.o -I /usr/include/hdf5/serial/ -lhdf5_serial -lboost_program_options -lpthread -lboost_log -DBOOST_LOG_DYN_LINK